...
object Mods {
    const val modmenu = "io.github.prospector:modmenu:2.0.4"
    const val libgui = "io.github.cottonmc:LibGui:4.1.5+${Minecraft.version}"
    const val nbtcrafting = "de.siphalor:nbtcrafting-1.17:2.0.19+mc1.17"
}
...
object Fabric {
    ...
    object YarnMappings {
        const val version = "${Minecraft.version}+build.32"
